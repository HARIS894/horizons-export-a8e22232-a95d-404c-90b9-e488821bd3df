  ...
  return (
    <>
      ...
      <PortalShell
        ...
        description="A premium family portal built on the same reusable healthcare data model as the CRM, ready for Supabase-powered sharing and permissions later."
        footerMeta={[
        ...
        <GlassPanel>
          <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            <div>
              ...
              <h2 className="mt-2 text-xl font-semibold text-slate-950 dark:text-white">Track a loved one with one shared data model</h2>
            </div>
        ...
        <GlassPanel>
          <div className="grid gap-4 md:grid-cols-3">
            ...
            <div className="rounded-[22px] border border-slate-200/70 bg-white/70 p-4 dark:border-slate-800 dark:bg-slate-950/40">
              ...
              <p className="mt-3 text-sm text-slate-700 dark:text-slate-200">Structured for WhatsApp, email, video update, voice note and PDF reports.</p>
            </div>
            <div className="rounded-[22px] border border-slate-200/70 bg-white/70 p-4 dark:border-slate-800 dark:bg-slate-950/40">
              <div className="flex items-center gap-2 text-slate-900 dark:text-white"><PhoneCall className="h-4 w-4" /> Family Support</div>
              <Button type="button" variant="outline" className="mt-3 rounded-full" onClick={() => handleAction('Support contact ready', 'Family support actions are UI-ready for secure messaging and callback workflows.')}>Request Call Back</Button>
            </div>
          </div>
        </GlassPanel>
      </PortalShell>
